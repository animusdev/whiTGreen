...
/obj/item/weapon/book/manual/barman_recipes
	...
	dat = {"<html>
				...
				<h1> ÓÍÚÂÈÎË ‰Î&#255; ˜‡ÈÌËÍÓ‚</h1>
				›ÚÓ Ì‡·Ó ÔÓÒÚÂÈ¯Ëı ÂˆÂÔÚÓ‚.

				<h2>Manly Dorf:</h2>
				—ÏÂ¯‡ÈÚÂ ›Î¸ Ë œË‚Ó ‚ ∏ÏÍÓÒÚË.

				<h2>Grog:</h2>
				—ÏÂ¯‡ÈÚÂ –ÓÏ Ë ¬Ó‰Û ‚ ∏ÏÍÓÒÚË..

				<h2>Black Russian:</h2>
				—ÏÂ¯‡ÈÚÂ ¬Ó‰ÍÛ Ë  ‡ÎÛ‡ ‚ ∏ÏÍÓÒÚË.

				<h2>Irish Cream:</h2>
				—ÏÂ¯‡ÈÚÂ  ÂÏ Ë ¬ËÒÍË ‚ ∏ÏÍÓÒÚË.

				<h2>Screwdriver:</h2>
				—ÏÂ¯‡ÈÚÂ ¬Ó‰ÍÛ Ë ¿ÔÂÎ¸ÒËÌÓ‚˚È ÒÓÍ ‚ ∏ÏÍÓÒÚË.

				<h2>Cafe Latte:</h2>
				—ÏÂ¯‡ÈÚÂ ÃÓÎÓÍÓ Ë  ÓÙÙÂ ‚ ∏ÏÍÓÒÚË.

				<h2>Mead:</h2>
				—ÏÂ¯‡ÈÚÂ ›ÌÁËÏ˚, ¬Ó‰Û Ë —‡ı‡  ‚ ∏ÏÍÓÒÚË.

				<h2>Gin Tonic:</h2>
				—ÏÂ¯‡ÈÚÂ ƒÊËÌ Ë “ÓÌËÍ ‚ ∏ÏÍÓÒÚË.

				<h2>Classic Martini:</h2>
				—ÏÂ¯‡ÈÚÂ ¬ÂÏÛÚ Ë ƒÊËÌ ‚ ∏ÏÍÓÒÚË.
