...
/obj/item/weapon/book/manual/barman_recipes
   ...
   dat = {"<html>
            ...
            <h1> ÓÍƒÂÈÎË ‰Î&#255; ˜‡ÈÌËÍÓ‚</h1>
            ›ƒÓ Ì‡·Ó ¡Ó«ƒÂÈ∆Ë  ÂˆÂ¡ƒÓ‚.

            <h2>Manly Dorf:</h2>
            «ÏÂ∆‡ÈƒÂ ›Î¸ Ë ¡Ë‚Ó ‚ ∏ÏÍÓ«ƒË.

            <h2>Grog:</h2>
            «ÏÂ∆‡ÈƒÂ –ÓÏ Ë ¬Ó‰Û ‚ ∏ÏÍÓ«ƒË..

            <h2>Black Russian:</h2>
            «ÏÂ∆‡ÈƒÂ ¬Ó‰ÍÛ Ë  ‡ÎÛ‡ ‚ ∏ÏÍÓ«ƒË.

            <h2>Irish Cream:</h2>
            «ÏÂ∆‡ÈƒÂ  ÂÏ Ë ¬Ë«ÍË ‚ ∏ÏÍÓ«ƒË.

            <h2>Screwdriver:</h2>
            «ÏÂ∆‡ÈƒÂ ¬Ó‰ÍÛ Ë ¿¡ÂÎ¸«ËÌÓ‚˚È «ÓÍ ‚ ∏ÏÍÓ«ƒË.

            <h2>Cafe Latte:</h2>
            «ÏÂ∆‡ÈƒÂ ÃÓÎÓÍÓ Ë  ÓÙÂ ‚ ∏ÏÍÓ«ƒË.

            <h2>Mead:</h2>
            «ÏÂ∆‡ÈƒÂ ›ÌÁËÏ˚, ¬Ó‰Û Ë «‡ ‡  ‚ ∏ÏÍÓ«ƒË.

            <h2>Gin Tonic:</h2>
            «ÏÂ∆‡ÈƒÂ ƒÊËÌ Ë ƒÓÌËÍ ‚ ∏ÏÍÓ«ƒË.

            <h2>Classic Martini:</h2>
            «ÏÂ∆‡ÈƒÂ ¬ÂÏÛƒ Ë ƒÊËÌ ‚ ∏ÏÍÓ«ƒË.
