...
/obj/structure/sign/portrait/rodger
   desc = " ра«ивое муже«ƒвенное лицо «урово взираеƒ на ва« « карƒины. Ёƒоƒ человек вну∆аеƒ «ƒра , уважение и необъ&#255;«нимо «ильную «имЅаƒию."
...
/obj/structure/sign/portrait/rodger/attackby(var/obj/item/weapon/W, mob/living/user, params)
   if(istype(W,/obj/item/weapon/extinguisher))
      if(blesses > 0)
         user << "<span class='userdanger'>§ Ѕо и бла овол&#255;ƒ вам!</span>"
         new /obj/item/weapon/reagent_containers/food/drinks/drinkingglass/milky(user.loc)
         blesses--
      else
         user.visible_message("<span class='warning'>§ ¬ам на ми  Ѕочудило«ь, будƒо [user] ударило молнией. Ѕо и не люб&#255;ƒ жадин.</span>", \
                         "<span class='userdanger'>§ Ѕо и не оценили ва∆у жадно«ƒь!</span>")
         playsound(loc, 'sound/effects/sparks1.ogg', 50, 1)
         user.adjustBrainLoss(5)
         user.Weaken(3)

/obj/structure/sign/portrait/ruben
   desc = " акой н&#255;∆ечка! ƒомный образ эƒо о оба&#255;ƒельно о дженƒльмена делаеƒ ва∆и ƒру«ики на«квозь мокрыми."
...
/obj/structure/sign/portrait/bisher
   desc = " ордый вз л&#255;д бывало о «олдаƒа, армей«ка&#255; выЅравка, му«кули«ƒа&#255; ∆е&#255;. ¬ы Ѕочƒи ощущаеƒе заЅа  наЅалма, и«ƒочаемый Ѕорƒреƒом."
