...
/atom/movable/proc/say_quote(input, list/spans)
   if(!input)
      return "Ê£Ê®Ê¢Ê®Ê°Ê¨Ê², \"...\""   //not the best solution, but it will stop a large number of runtimes. The cause is somewhere in the Tcomms code
