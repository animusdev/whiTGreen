...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("avatarstep") soundin = pick('sound/effects/footsteps/heavystep1.ogg','sound/effects/footsteps/heavystep2.ogg','sound/effects/footsteps/heavystep3.ogg','sound/effects/footsteps/heavystep4.ogg')
	return soundin
