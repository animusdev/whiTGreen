...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("avatarstep") soundin = pick('sound/effects/footsteps/heavystep1.wav','sound/effects/footsteps/heavystep2.wav','sound/effects/footsteps/heavystep3.wav','sound/effects/footsteps/heavystep4.wav')
	return soundin
