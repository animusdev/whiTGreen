/datum/game_mode/traitor/double_agents
   ...
   restricted_jobs = list("Cyborg", "AI", "Head of Personnel", "Chief Medical Officer", "Research Director", "Chief Engineer") // Human / Minor roles only.
...
/datum/game_mode/traitor/double_agents/announce()
   world << "<B>ƒекущий и ровой режим - double agents!</B>"
   world << "<B>Ќа «ƒанции дей«ƒвуюƒ двойные а енƒы, коƒорые убиваюƒ дру  дру а! Ќе дайƒе им выЅолниƒь и  цели.</B>"
...
/datum/game_mode/traitor/double_agents/forge_traitor_objectives(var/datum/mind/traitor)
   ...
   if(target_list.len && target_list[traitor]) // Is a double agent
      ...
      kill_objective.explanation_text = "”биƒь [kill_objective.target.current.real_name]."
