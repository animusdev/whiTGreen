...
/datum/game_mode/proc/greet_thing(var/datum/mind/thing, var/you_are=1)
	if (you_are)
		thing.current << "<span class='boldannounce'>� �� - �����! �������� ������ �� ������ ������� � ����&#255;� ��� ����� �� �������� �� �������.</span>"
	thing.current << "� �� ������ ���������� ���� ������ �������!</b>"
...
/datum/game_mode/proc/auto_declare_completion_thing()
	if(things.len)
		var/text = "<br><font size=3><b>������ ����:</b></font>"
		for(var/datum/mind/thing in things)
			var/thingwin = 1
			if(!thing.current)
				thingwin = 0
			...
			text += "<br><b>����� ���������:</b> [thing.the_thing.absorbedcount]"

			if(thingwin)
				text += "<br><font color='green'><b>����� ������� ������ ������!</b></font>"
			else
