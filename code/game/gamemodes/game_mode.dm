...
/datum/game_mode/proc/send_intercept()
	...
	possible_modes.Add("revolution", "wizard", "nuke", "traitor", "malf", "changeling", "cult", "gang", "the thing")
	...
	priority_announce("Сводка загружена и распечатана на всех коммуникационных консолях.", "Обнаружена система вражеских коммуникаций. Повышен уровень безопасности.", 'sound/AI/intercept.ogg')
...
/datum/game_mode/proc/get_players_for_role(var/role)
	...
	switch(role)
		...
		if(BE_THING)		roletext="the thing"
