...
/datum/game_mode/proc/send_intercept()
   ...
   priority_announce("«водка за ружена и ра«Ѕечаƒана на в«е  коммуникационны  кон«ол&#255; .", "ќбнаружена «и«ƒема враже«ки  коммуникаций. Ѕовы∆ен уровень безоЅа«но«ƒи.", 'sound/AI/intercept.ogg')
