...
/datum/game_mode/traitor/changeling/announce()
   world << "<B>ƒекущий и ровой режим - traitorchan!</B>"
   world << "<B>ј енƒы «индикаƒа ƒайно Ѕроникли на «ƒанцию вме«ƒе « иноЅланеƒными ор анизмами, изве«ƒными как  енокрады. Ќе дайƒе им выЅолниƒь «вои задани&#255;!</B>"
