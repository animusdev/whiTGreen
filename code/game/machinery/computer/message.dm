					...
					if("Send")
						...
						if(isnull(PDARec))
							...
							if (!customrecepient.silent)
								...
								log_pda("[usr.ckey]/[usr] (PDA: [customsender]) sent \"[custommessage]\" to [customrecepient.owner]")
						...
						//Sender is faking as someone who exists
							...
							if (!customrecepient.silent)
								...
								log_pda("[usr.ckey]/[usr] (PDA: [PDARec.owner]) sent \"[custommessage]\" to [customrecepient.owner]")
								customrecepient.overlays.Cut()
								customrecepient.overlays += image('icons/obj/pda.dmi', "pda-r")
						//Finally..
						ResetMessage()
