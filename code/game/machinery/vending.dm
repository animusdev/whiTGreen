...
/obj/machinery/vending/boozeomat
	...
	vend_delay = 15
	product_slogans = "Надеюсь, никто не попросит у меня чашку чая...*Алкоголь - друг человека! Бросишь ли ты своего друга?*Рад служить вам!*Разве никто не страдает от жажды на станции?"
	product_ads = "Губит людей не пиво, губит людей вода!*До дна!*Выпивка на благо!*Алкоголь - лучший друг человека!*Рад служить!*Не хочешь ли хорошего, холодного пива?*Ничто не исцеляет так, как это делает выпивка!*Всего глоток!*Выпей!*Закажи пива!*Пиво на пользу тебе!*Только лучший алкоголь!*Лучшее качество выпивки с начала двухтысячелетия!*Лучшее вино!*М-М-Максимум алкоголя!*Мужчина предпочитает пиво.*Тост для прогресса!"
	req_access_txt = "25"
...
/obj/machinery/vending/assist
	...
	product_ads = "Только лучшее!*Экипируйся!*Самая крепкая экипировка!*Лучшее снаряжение в секторе!"

/obj/machinery/vending/coffee
	name = "\improper Solar's Best Hot Drinks"
	desc = "A vending machine which dispenses hot drinks."
	product_ads = "Напитки для тебя!*Утоли жажду!*Вам понравится!*Чашечку кофе?*Я бы убил ради глотка кофе!*Лучшие бобы в секторе!*Только лучшие напитки для вас.*М-м-м, бесподобное кофе.*Я люблю кофе, а вы?*Кофе в помощь для работы!*Попробуйте наш чай.*Надеюсь, вам нравится лучшее!*Попробуйте наш новый шоколад!"
	icon_state = "coffee"
...
/obj/machinery/vending/snack
	...
	product_ads = "Самое натуральное!*Лучшие плитки шоколада! Не пытайтесь кидаться ими!*М-м-м, так вкусно.*Господи, он такой сочный!*Перекуси!*Перекуси, тебе понравится!*Больше шоколада господу шоколада!*Вкусности лучшего качества прямиком с Марса!*Все мы любим шоколад!*Попробуйте наше вяленое мясо!"
	icon_state = "snack"
...
/obj/machinery/vending/sustenance
	...
	product_slogans = "Наслаждайся едой, пока можешь.*Достаточно калорий для тебя и твоих исправительных работ."
	product_ads = "Достаточно полезно.*Тофу без затрат!*М-м-м, как вкусно!*Перекуси.*Тебе нужна еда для выживания!*Сладкий попкорн!*Попробуй наш отменный лёд, грызи лёд во славу Корпорации!"
...
/obj/machinery/vending/cola
	...
	product_slogans = "Крепкие Напитки: бьют в голову сильнее огнетушителя!"
...
/obj/machinery/vending/cigarette
	...
	product_slogans = "Космосигареты на вкус почти как настоящие!*Предпочитаю смерть смене привычки!*Кури!*Не верь статистике - покури!"
	product_ads = "Может и не навредит!*Не верь учёным!*Это полезно для тебя!*Не бросай, купи ещё!*Кури!*Никотиновый рай.*Лучшие раковые палочки на протяжении четырёх веков.*Лучшие сигареты!"
	vend_delay = 34
	icon_state = "cigs"
...
/obj/machinery/vending/medical
	...
	icon_state = "med"
	icon_deny = "med-deny"
	product_ads = "Самое время спасать жизни!*Лучшее для медотсека!*Натуральная химия!*ЭТО спасает жизни!*Не хочешь немного медицины? Легально!"
	req_access_txt = "5"
...
/obj/machinery/vending/plasmaresearch
	...
	desc = "Всё для тебя и твоих взрывоопасных желаний!"
...
/obj/machinery/vending/security
	...
	product_ads = "Кроши черепа!*Разбивай головы!*Не забудь: вред - хорошо!*Твоё оружие ждёт тебя!*Наручники!*Стоять, ублюдок!*Не оглушай - выбивай дух из них!*Оглуши их!*Может, пончик?*И запомни: ни слова при задержании!"
	icon_state = "sec"
	icon_deny = "sec-deny"
	req_access_txt = "1"
...
/obj/machinery/vending/hydronutrients
	...
	product_slogans = "Не рад тому, что не нужно удобрять как в старые добрые?*Теперь в два раза меньше вони!*Растения - тоже люди!"
	product_ads = "Все мы любим растения!*Не вздумайте пить аммиак!*Для самых извращённых садоводов!*Мне нравятся БОЛЬШИЕ растения"
	icon_state = "nutri"
...
/obj/machinery/vending/hydroseeds
	...
	product_slogans = "РОДИНА СЕМЯН, СПЕШИ ЛИШИТЬ ИХ СВОЕГО ДОМА!*Семена лучшей селекции, их даже можно потрогать!*Большой ассортимент грибов! Ещё больше для <I>экспертов</I>! Получи свой гриб совершенно легально!"
...
/obj/machinery/vending/magivend
	...
	icon_state = "MagiVend"
	product_slogans = "Заклинания-М1 в МагиТорге!*Стань Гудини! Используй МагиТорг!"
	vend_delay = 15
...
/obj/machinery/vending/autodrobe
	...
	product_slogans = "Нарядись для успеха!*Обут и одет!*Время для подиума!*Зачем бросать стиль на самотёк? Используй АвтоРоб!"
	vend_delay = 15
...
/obj/machinery/vending/dinnerware
	...
	product_ads = "М-м-м, еда!*Еда, еда и еда!*Получите свои тарелки!*Нравятся вилки, м-м?*Я люблю вилки.*Ух, посуда!*Она тебе не понадобится..."
...
/obj/machinery/vending/sovietsoda
	...
	product_ads = "За веру, Царя и Отечество!*Вы выполнили свою пищевую квоту?*Очень хорошо!*Мы простые люди, нам этого хватает.*Есть люди - есть проблемы. Нет людей - нет проблем!"
...
/obj/machinery/vending/clothing
	...
	icon_state = "clothes"
	product_slogans = "Нарядись для успеха!*Готовься выглядеть освэгенно!*Только посмотри на всё это!*Зачем бросать стиль на самотёк? Используй ОдежТорг!"
	vend_delay = 15
