...
/obj/machinery/suit_storage_unit/attack_hand(mob/user as mob)
	...
	if(src.panelopen) //The maintenance panel is open. Time for some shady stuff
		...
		dat+= text("A small dial with a \"л\" symbol embroidded on it. It's pointing towards a gauge that reads [].<BR> <A href='?src=\ref[];toggleUV=1'> Turn towards []</A><BR>",(src.issuperUV ? "15nm" : "185nm"),src,(src.issuperUV ? "185nm" : "15nm") )
