...
/datum/instrument/piano/crisis_harpsichord
   ...
   id = "crharpsi"
   samples = list("36"='sound/samples/piano/crisis_harpsichord/c2.ogg',
               "48"='sound/samples/piano/crisis_harpsichord/c3.ogg',
               "60"='sound/samples/piano/crisis_harpsichord/c4.ogg',
               "72"='sound/samples/piano/crisis_harpsichord/c5.ogg')
