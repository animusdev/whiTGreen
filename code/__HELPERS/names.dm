...
/proc/generate_code_phrase()//Proc is used for phrase and response in master_controller.dm
	...
	var/nouns[] = list("любовь","ненависть","злость","мир","общество","симпати&#255;","великолепный","преданный","благородный","внедрение","составной","благотворительность","успешно","мужество","обман","навык","чудо","великолепное","боль","странное","доверие","мечты","справедливость","доверие","фетиш","свобода","знани&#255;","касание","информаци&#255;","культура","вера","дикци&#255;","развитие","образование","здравоохранение","ожирение","проблемы","дружба", "расслабление")
	var/drinks[] = list("водка и тоник","джинн","багама-мама","манхэттан","черный Русский","аиски","лонг-айлендский чай","маргарита","Ирландский кофе"," пь&#255;ный карлик","Ирландские сливки","божественный напиток","Бипскай","Текила","храбрый бык","бластер","кровава&#255; мерри","виски-кола","белый Русский","водка-мартини","мартини","Кубинска&#255; свобода","калуа","водка","вино","самогон")
