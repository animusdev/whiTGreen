...
/proc/generate_code_phrase()//Proc is used for phrase and response in master_controller.dm
   ...
   var/nouns[] = list("«аморазру∆ение", "оƒча&#255;ние", "ненави«ƒь", "рефлек«и&#255;", "алко олизм", "зави«имо«ƒь", "одиноче«ƒво", "деЅре««и&#255;", "«амоубий«ƒво", "бе««мы«ленно«ƒь", "вечно«ƒь", "Ѕро«ƒиƒуƒка", "ƒ&#255;желые наркоƒики", "лицемерие", "за овор", "оƒвращение", "безразличие", "рели и&#255;", "Ѕо ороны", "фанаƒик", "Ѕредаƒель«ƒво")
   var/drinks[] = list("белый ру««кий", "джин-ƒоник", "мар ариƒа", " уба Ћибре", "ви«ки « колой", "чЄрный ру««кий", "лон -айленд")
   var/russian_jobs[] = list("а««и«ƒенƒ", "каЅиƒан", "менеджер Ѕо Ѕер«оналу", "бармен", "Ѕовар", "боƒаник", "каЅƒер", " рузчик", "∆а ƒЄр", "клоун", "мим", "уборщик", "библиоƒекарь", "адвокаƒ", "«в&#255;щенник", " лавный инженер", "инженер", "аƒмо«ферный ƒе ник", " лавный врач", "врач", " имик", " енеƒик", "виру«оло ", " лава о раны", "офицер безоЅа«но«ƒи", "«моƒриƒель", "деƒекƒив", "учЄный", "робоƒе ник", "и««ледоваƒель«кий дирекƒор")
