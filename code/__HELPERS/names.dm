...
/proc/generate_code_phrase()//Proc is used for phrase and response in master_controller.dm
	...
	var/nouns[] = list("саморазрушение", "отчаяние", "ненависть", "рефлексия", "алкоголизм", "зависимость", "одиночество", "депрессия", "самоубийство", "бессмысленность", "вечность", "проститутка", "тяжелые наркотики", "лицемерие", "заговор", "отвращение", "безразличие", "религия", "похороны", "фанатик", "предательство")
	var/drinks[] = list("белый русский", "джин-тоник", "маргарита", "Куба Либре", "виски с колой", "чёрный русский", "лонг-айленд")
	var/russian_jobs[] = list("ассистент", "капитан", "менеджер по персоналу", "бармен", "повар", "ботаник", "каптер", "грузчик", "шахтёр", "клоун", "мим", "уборщик", "библиотекарь", "адвокат", "священник", "главный инженер", "инженер", "атмосферный техник", "главный врач", "врач", "химик", "генетик", "вирусолог", "глава охраны", "офицер безопасности", "смотритель", "детектив", "учёный", "роботехник", "исследовательский директор")
