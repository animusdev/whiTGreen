...
/datum/uplink_item/stealthy_tools/chameleon_stamp
	...
	desc = "A stamp that can be activated to imitate an official Nanotrasen StampВ™. The disguised stamp will work exactly like the real stamp and will allow you to forge false documents to gain access or equipment; \
...
/datum/uplink_item/implants/storage
	...
	desc = "An implant injected into the body and later used to store up to two big items."
