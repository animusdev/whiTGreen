...
/datum/subsystem/job/proc/EquipRank(mob/living/H, rank, joined_late=0)
   ...
   H << "<b>¬ы [job.r_title].</b>"
   H << "<b>¬ы Ѕодчин&#255;еƒе«ь [job.supervisors]. Ёƒо можеƒ измениƒь«&#255; Ѕри о«обы  об«ƒо&#255;ƒель«ƒва .</b>"
   H << "<b>„ƒобы раз овариваƒь Ѕо радиоканалу «вое о оƒдела и«Ѕользуй ЅриЅи«ку :h. ќ«моƒриƒе «вой нау∆ник, чƒобы узнаƒь до«ƒуЅные радиоканалы.</b>"
   if(job.req_admin_notify)
      H << "<b>¬ы зан&#255;ли важную Ѕрофе««ию. ≈«ли вы чƒо-ƒо не знаеƒе или забыли - не бойƒе«ь «Ѕро«иƒь админи«ƒрацию через adminhelp (F1).</b>"
   if(config.minimal_access_threshold)
