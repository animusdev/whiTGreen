...
/obj/docking_port/mobile/emergency/request(obj/docking_port/stationary/S, coefficient=1, area/signalOrigin, reason, redAlert)
   ...
   priority_announce("¬ызван эвакуационный ∆аƒƒл. [redAlert ? "Red Alert state confirmed: Dispatching priority shuttle. " : "" ]ќжидаемое врем&#255; Ѕрибыƒи&#255;: [timeLeft(600)] минуƒ.[reason][SSshuttle.emergencyLastCallLoc ? "\n\n»«ƒочник «и нала иденƒифицирован, данные о е о ме«ƒоЅоложении до«ƒуЅны « любой коммуникационной кон«оли." : "" ]", null, 'sound/AI/shuttlecalled.ogg', "Priority")
...
/obj/docking_port/mobile/emergency/cancel(area/signalOrigin)
   ...
   if(prob(70))
      ...
      SSshuttle.emergencyLastCallLoc = null
   priority_announce("Ёвакуационный ∆аƒƒл был оƒозван.[SSshuttle.emergencyLastCallLoc ? " »«ƒочник «и нала иденƒифицирован, данные о е о ме«ƒоЅоложении до«ƒуЅны « любой коммуникационной кон«оли." : "" ]", null, 'sound/AI/shuttlerecalled.ogg', "Priority")
   ...
   switch(mode)
      ...
      if(SHUTTLE_CALL)
         if(time_left <= 0)
            ...
            mode = SHUTTLE_DOCKED
            timer = world.time
            priority_announce("Ёвакуационный ∆аƒƒл Ѕрибыл на «ƒанцию. ¬ ва∆ем ра«Ѕор&#255;жении [timeLeft(600)] минуƒы на Ѕо«адку.", null, 'sound/AI/shuttledock.ogg', "Priority")
      if(SHUTTLE_DOCKED)
         ...
         if(time_left <= 0 && !SSshuttle.emergencyNoEscape)
            ...
            mode = SHUTTLE_ESCAPE
            timer = world.time
            priority_announce("Ёвакуационный ∆аƒƒл Ѕокинул «ƒанцию. ќ«ƒало«ь [timeLeft(600)] минуƒы до Ѕрибыƒи&#255; в доки ÷енƒрально о  оммандовани&#255;.", null, null, "Priority")
      if(SHUTTLE_ESCAPE)
         if(time_left <= 0)
