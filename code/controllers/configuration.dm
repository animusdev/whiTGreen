...
/datum/configuration
	...
	var/alert_desc_green = "Все угрозы для жизни персонала ликвидированы. Сотрудникам службы безопасности нельзя открыто носить оружие, права на неприкосновенность частной жизни действуют в полную силу."
	var/alert_desc_blue_upto = "Получена информация о возможной вражеской активности на станции. Сотрудники службы безопасности имеют право открыто носить оружие и проводить произвольные обыски."
	var/alert_desc_blue_downto = "Прямая угроза станции устранена. Сотрудникам службы безопасности не позволено ходить с оружием в руках, но открытое ношение разрешено. Произвольные обыски по-прежнему разрешены."
	var/alert_desc_red_upto = "Возникла серьезная угроза жизни персонала. Сотрудникам службы безопасности разрешено ходить с оружием наизготовку. Произвольные обыски персонала разрешены и настоятельно рекомендуются."
	var/alert_desc_red_downto = "Механизм самоуничтожения станции деактивирован, но все еще существует серьезная угроза жизни персонала. Сотрудникам службы безопасности разрешено ходить с оружием наизготовку. Произвольные обыски персонала разрешены и настоятельно рекомендуются."
	var/alert_desc_delta = "Запущен механизм самоуничтожения станции. Персонал обязан подчиняться всем инструкциям и распоряжениям со стороны руководительского состава. Любое нарушение подобного приказа может караться смертью. Это не учения."
...
/datum/configuration/proc/load(filename) //the type can also be game_options, in which case it uses a different switch. not making it separate to not copypaste code - Urist
	...
	for(var/t in Lines)
		...
		switch(name)
			...
			if("alert_red_upto")
				config.alert_desc_red_upto		= "Возникла серьезная угроза жизни персонала. Сотрудникам службы безопасности разрешено ходить с оружием наизготовку. Произвольные обыски персонала разрешены и настоятельно рекомендуются."
			if("alert_red_downto")
				config.alert_desc_red_downto	= "Механизм самоуничтожения станции деактивирован, но все еще существует серьезная угроза жизни персонала. Сотрудникам службы безопасности разрешено ходить с оружием наизготовку. Произвольные обыски персонала разрешены и настоятельно рекомендуются."
			if("alert_blue_downto")
				config.alert_desc_blue_downto	= "Прямая угроза станции устранена. Сотрудникам службы безопасности не позволено ходить с оружием в руках, но открытое ношение разрешено. Произвольные обыски по-прежнему разрешены."
			if("alert_blue_upto")
				config.alert_desc_blue_upto		= "Получена информация о возможной вражеской активности на станции. Сотрудники службы безопасности имеют право открыто носить оружие и проводить произвольные обыски."
			if("alert_green")
				config.alert_desc_green			= "Все угрозы для жизни персонала ликвидированы. Сотрудникам службы безопасности нельзя открыто носить оружие, права на неприкосновенность частной жизни действуют в полную силу."
			if("alert_delta")
				config.alert_desc_delta			= "Запущен механизм самоуничтожения станции. Персонал обязан подчиняться всем инструкциям и распоряжениям со стороны руководительского состава. Любое нарушение подобного приказа может караться смертью. Это не учебная тревога."
			if("sec_start_brig")
