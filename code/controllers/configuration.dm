...
/datum/configuration
   ...
   var/alert_desc_green = "¬«е у розы дл&#255; жизни Ѕер«онала ликвидированы. «оƒрудникам «лужбы безоЅа«но«ƒи нельз&#255; оƒкрыƒо но«иƒь оружие, Ѕрава на неЅрико«новенно«ƒь ча«ƒной жизни дей«ƒвуюƒ в Ѕолную «илу."
   var/alert_desc_blue_upto = "Ѕолучена информаци&#255; о возможной враже«кой акƒивно«ƒи на «ƒанции. «оƒрудники «лужбы безоЅа«но«ƒи имеюƒ Ѕраво оƒкрыƒо но«иƒь оружие и Ѕроводиƒь Ѕроизвольные обы«ки."
   var/alert_desc_blue_downto = "Ѕр&#255;ма&#255; у роза «ƒанции у«ƒранена. «оƒрудникам «лужбы безоЅа«но«ƒи не Ѕозволено  одиƒь « оружием в рука , но оƒкрыƒое но∆ение разре∆ено. Ѕроизвольные обы«ки Ѕо-Ѕрежнему разре∆ены."
   var/alert_desc_red_upto = "¬озникла «ерьезна&#255; у роза жизни Ѕер«онала. «оƒрудникам «лужбы безоЅа«но«ƒи разре∆ено  одиƒь « оружием наиз оƒовку. Ѕроизвольные обы«ки Ѕер«онала разре∆ены и на«ƒо&#255;ƒельно рекомендуюƒ«&#255;."
   var/alert_desc_red_downto = "ће анизм «амоуничƒожени&#255; «ƒанции деакƒивирован, но в«е еще «уще«ƒвуеƒ «ерьезна&#255; у роза жизни Ѕер«онала. «оƒрудникам «лужбы безоЅа«но«ƒи разре∆ено  одиƒь « оружием наиз оƒовку. Ѕроизвольные обы«ки Ѕер«онала разре∆ены и на«ƒо&#255;ƒельно рекомендуюƒ«&#255;."
   var/alert_desc_delta = "«аЅущен ме анизм «амоуничƒожени&#255; «ƒанции. Ѕер«онал об&#255;зан Ѕодчин&#255;ƒь«&#255; в«ем ин«ƒрукци&#255;м и ра«Ѕор&#255;жени&#255;м «о «ƒороны руководиƒель«ко о «о«ƒава. Ћюбое нару∆ение Ѕодобно о Ѕриказа можеƒ караƒь«&#255; «мерƒью. Ёƒо не учени&#255;."
...
/datum/configuration/proc/load(filename) //the type can also be game_options, in which case it uses a different switch. not making it separate to not copypaste code - Urist
   ...
   for(var/t in Lines)
      ...
      switch(name)
         ...
         if("alert_red_upto")
            config.alert_desc_red_upto      = "¬озникла «ерьезна&#255; у роза жизни Ѕер«онала. «оƒрудникам «лужбы безоЅа«но«ƒи разре∆ено  одиƒь « оружием наиз оƒовку. Ѕроизвольные обы«ки Ѕер«онала разре∆ены и на«ƒо&#255;ƒельно рекомендуюƒ«&#255;."
         if("alert_red_downto")
            config.alert_desc_red_downto   = "ће анизм «амоуничƒожени&#255; «ƒанции деакƒивирован, но в«е еще «уще«ƒвуеƒ «ерьезна&#255; у роза жизни Ѕер«онала. «оƒрудникам «лужбы безоЅа«но«ƒи разре∆ено  одиƒь « оружием наиз оƒовку. Ѕроизвольные обы«ки Ѕер«онала разре∆ены и на«ƒо&#255;ƒельно рекомендуюƒ«&#255;."
         if("alert_blue_downto")
            config.alert_desc_blue_downto   = "Ѕр&#255;ма&#255; у роза «ƒанции у«ƒранена. «оƒрудникам «лужбы безоЅа«но«ƒи не Ѕозволено  одиƒь « оружием в рука , но оƒкрыƒое но∆ение разре∆ено. Ѕроизвольные обы«ки Ѕо-Ѕрежнему разре∆ены."
         if("alert_blue_upto")
            config.alert_desc_blue_upto      = "Ѕолучена информаци&#255; о возможной враже«кой акƒивно«ƒи на «ƒанции. «оƒрудники «лужбы безоЅа«но«ƒи имеюƒ Ѕраво оƒкрыƒо но«иƒь оружие и Ѕроводиƒь Ѕроизвольные обы«ки."
         if("alert_green")
            config.alert_desc_green         = "¬«е у розы дл&#255; жизни Ѕер«онала ликвидированы. «оƒрудникам «лужбы безоЅа«но«ƒи нельз&#255; оƒкрыƒо но«иƒь оружие, Ѕрава на неЅрико«новенно«ƒь ча«ƒной жизни дей«ƒвуюƒ в Ѕолную «илу."
         if("alert_delta")
            config.alert_desc_delta         = "«аЅущен ме анизм «амоуничƒожени&#255; «ƒанции. Ѕер«онал об&#255;зан Ѕодчин&#255;ƒь«&#255; в«ем ин«ƒрукци&#255;м и ра«Ѕор&#255;жени&#255;м «о «ƒороны руководиƒель«ко о «о«ƒава. Ћюбое нару∆ение Ѕодобно о Ѕриказа можеƒ караƒь«&#255; «мерƒью. Ёƒо не учебна&#255; ƒрево а."
         if("sec_start_brig")
