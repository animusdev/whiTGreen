...
/datum/configuration
	...
	var/alert_desc_blue_upto = "ѕолучена информаци&#255; о возможной вражеской активности на станции. —отрудники службы безопасности имеют право открыто носить оружие и проводить произвольные обыски."
