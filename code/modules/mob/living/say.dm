var/list/department_radio_keys = list(
     ...
     ":Ж" = "intercom",   "#Ж" = "intercom",      ".Ж" = "intercom",
     ":р" = "department",   "#р" = "department",   ".р" = "department",
     ":З" = "Command",      "#З" = "Command",      ".З" = "Command",
     ":Д" = "Science",      "#Д" = "Science",      ".Д" = "Science",
     ...
     ":К" = "Supply",      "#К" = "Supply",      ".К" = "Supply",
     ":м" = "Service",      "#м" = "Service",      ".м" = "Service",
     ":Б" = "changeling",   "#Б" = "changeling",   ".Б" = "changeling",
...
/mob/living/say(message, bubble_type,)
   ...
   var/message_mode = null//get_message_mode(message)
...
/mob/living/say_quote(input, list/spans)
   ...
   if (stuttering)
      return "заикаеДЗ&#255;, \"[tempinput]\""
   if (getBrainLoss() >= 60)
      return "бормочеД, \"[tempinput]\""
   return ..()
