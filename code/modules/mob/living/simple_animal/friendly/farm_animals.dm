...
/mob/living/simple_animal/hostile/retaliate/goat
   ...
   speak_emote = list("блееƒ")
   emote_hear = list("блееƒ.")
   emote_see = list("ƒр&#255;«Єƒ  оловой.", "бьЄƒ коЅыƒом.", "«виреЅо «моƒриƒ Ѕо «ƒоронам.")
   speak_chance = 1
   turns_per_move = 5
   see_in_dark = 6
...
/mob/living/simple_animal/cow
   ...
   speak_emote = list("мычиƒ","Ѕродолжиƒельно мычиƒ")
   emote_hear = list("кричиƒ.")
   emote_see = list("ƒр&#255;«Єƒ  оловой.")
   speak_chance = 1
   turns_per_move = 5
   see_in_dark = 6
...
/mob/living/simple_animal/chick
   ...
   speak_emote = list("Ѕищиƒ")
   emote_hear = list("Ѕищиƒ.")
   emote_see = list("клюЄƒ землю.","ма∆еƒ «воими кро оƒными крылы∆ками.")
   density = 0
   speak_chance = 2
   turns_per_move = 2
...
/mob/living/simple_animal/chicken
   ...
   speak = list(" уда !"," ќќќ- ќ- ќ!"," ”ƒј -ƒј -ƒј !", " ќ- ќ- ќ- ќ!")
   speak_emote = list("куда чеƒ")
   emote_hear = list("куда чеƒ.")
   emote_see = list("клюЄƒ землю.","&#255;ро«ƒно ма∆еƒ «воими крыль&#255;ми.")
   density = 0
   speak_chance = 2
   turns_per_move = 3
