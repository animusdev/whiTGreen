...
/mob/living/simple_animal/pet/cat
   ...
   gender = MALE
   languages = CAT
   speak = list("ћ&#255;у!", "ћур-м&#255;у!", "ћрррр!", "∆∆∆∆∆!")
   speak_emote = list("мурлычеƒ", "м&#255;укаеƒ")
   emote_hear = list("м&#255;укаеƒ.", "мурчиƒ.", "мурлычеƒ.", "∆иЅиƒ.")
   emote_see = list("ƒр&#255;«Єƒ  оловой.", "дрожиƒ.", "и раеƒ«&#255; «о «воим  во«ƒом.")
   speak_chance = 1
   turns_per_move = 5
   see_in_dark = 6
   ventcrawler = 2
