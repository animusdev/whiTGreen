...
/mob/living/simple_animal/pet/corgi
   ...
   speak_emote = list("лаеƒ", " авкаеƒ")
   emote_hear = list("лаеƒ!", " авкаеƒ!", "ƒ&#255;вкаеƒ.","Ѕы ƒиƒ.")
   emote_see = list("ƒр&#255;«Єƒ  оловой.", "ƒр&#255;«Єƒ«&#255;.")
   speak_chance = 1
   turns_per_move = 10
      ...
      switch(remove_from)
         if("head")
            if(inventory_head)
               ...
               speak_emote = list("лаеƒ", " авкаеƒ")
               emote_hear = list("лаеƒ.", " авкаеƒ.", "ƒ&#255;вкаеƒ.","Ѕы ƒиƒ.")
               emote_see = list("ƒр&#255;«Єƒ  оловой.", "дрожиƒ.")
               desc = "It's a corgi."
               SetLuminosity(0)
   ...
   if(istype(item_to_add, /obj/item/clothing/scarf))
      ...
      switch(item_to_add.type)
         ...
         if(/obj/item/clothing/head/kitty, /obj/item/clothing/head/collectable/kitty)
            name = "Runtime"
            emote_see = list("выка∆ливаеƒ комок ∆ер«ƒи.", "ƒ&#255;неƒ«&#255;.")
            emote_hear = list("мурлычеƒ.")
         ...
         if(/obj/item/clothing/head/rabbitears, /obj/item/clothing/head/collectable/rabbitears)
            name = "Hoppy"
            emote_see = list("ЅодЄр иваеƒ «воим но«ом.", "«качеƒ вокру  «еб&#255;.")
         ...
         if(/obj/item/clothing/head/beret, /obj/item/clothing/head/collectable/beret)
            ...
            emote_see = list("дрожиƒ в ужа«е!", "«даЄƒ«&#255;!", "Ѕрикинул«&#255; мЄрƒвым.","looks as though there is a wall in front of him.")
            valid = 1

         if(/obj/item/clothing/head/det_hat)
            name = "Detective [real_name]"
            desc = "[name] sees through your lies..."
            emote_see = list("ра««ледуеƒ окружение.","выню иваеƒ улики.","выи«киваеƒ чƒо-ƒо.")
            valid = 1
         ...
         if(/obj/item/clothing/head/pirate, /obj/item/clothing/head/collectable/pirate)
            ...
            emote_see = list("о оƒиƒ«&#255; за «окровищами."," ладнокровно «моƒриƒ...","«крежещеƒ «воими маленькими зубками!")
            emote_hear = list("«виреЅо рычиƒ!", "рычиƒ.")
         ...
         if(/obj/item/clothing/head/ushanka)
            ...
            emote_see = list("«озерцаеƒ Ѕровалы каЅиƒали«ƒиче«кой модели экономики.", "взве∆иваеƒ ''за'' и ''Ѕроƒив'' аван ардизма.")
            valid = 1

         if(/obj/item/clothing/head/warden, /obj/item/clothing/head/collectable/police)
            name = "Officer [real_name]"
            emote_see = list("Ѕу«каеƒ «люни.","выи«киваеƒ Ѕончики.")
            desc = "Stop right there criminal scum!"
            valid = 1

         if(/obj/item/clothing/head/wizard/fake,   /obj/item/clothing/head/wizard,   /obj/item/clothing/head/collectable/wizard)
            name = "Grandwizard [real_name]"
            speak = list("STI KALY", "FORTY GU AMA!", "Bark!", "AUUUUUU", "EI  NATH!")
            valid = 1

         if(/obj/item/clothing/head/cardborg)
            name = "Borgi"
            speak = list("Ping!","Beep!","Woof!")
            emote_see = list("Ѕри одиƒ в безумие!", "Ѕроню иваеƒ нелюдей.")
         ...
         if(/obj/item/weapon/bedsheet)
            ...
            emote_see = list("∆аƒаеƒ«&#255;.", "дрожиƒ.")
            emote_hear = list("воеƒ!","мычиƒ.")
            desc = "Spooky!"
            valid = 1

         if(/obj/item/clothing/head/helmet/space/santahat)
            name = "Santa's Corgi Helper"
            emote_hear = list("Ѕролаиваеƒ Ѕе«ни –ожде«ƒва.", "ве«ело ƒ&#255;вкаеƒ!")
            emote_see = list("выи«киваеƒ Ѕодарки.", "Ѕровер&#255;еƒ «вой «Ѕи«ок.")
         ...
         if(/obj/item/clothing/head/hardhat/reindeer)
            ...
            emote_hear = list("о«вещаеƒ Ѕуƒь!", "за ораеƒ«&#255;.", "ƒ&#255;вкаеƒ!")
