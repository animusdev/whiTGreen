/mob/living/simple_animal/slime
   ...
   emote_see = list("Áîêà÷èâàåÄÇ&#255;.", "ÁîäÁðûÊèâàåÄ íà ìåÇÄå.")
   speak_emote = list("ÄðåùèÄ")
   ...
   verb_say = "ÄåëåÁàÄè÷åÇêè ÆåÁ÷åÄ"
   verb_engsay = "chirps"
   verb_ask = "ÄåëåÁàÄè÷åÇêè ÇÁðàÆèâàåÄ"
   verb_exclaim = "ÄåëåÁàÄè÷åÇêè êðè÷èÄ"
   verb_yell = "ÄåëåÁàÄè÷åÇêè âîÁèÄ"
