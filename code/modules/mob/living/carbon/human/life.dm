	...
	if(!stat)
		if (getToxLoss() >= 45 && nutrition > 20)
			...
			if(lastpuke >= 25) // about 25 second delay I guess
				...
				visible_message("<span class='danger'>[src] ñòîøëèëî!</span>", \
						"<span class='userdanger'>[src] ñòîøíèëî!</span>")
