...
/mob/living/carbon/human/handle_disabilities()
	...
	if (getBrainLoss() >= 60 && stat != DEAD)
		if (prob(3))
			switch(pick(1,2,3))
				if(1)
					say(pick("Они повсюду! Несите огнеметы!", "Оставь эти сложности, детка, просто возьми мой член", "КОНЕЦ СВЕТА БЛИЗОК" ,"Я вижу духов умерших, они говор&#255;т со мной!", "КАПИТАН ГАНДОН!", "РАССЛАБЛЯЙТЕ БУЛКИ, ГОТОВЬТЕ ЗАДНИЦЫ, ИБО ГРЯДЕТ!!!", "ХОС ХУЕСОС!", "ЛЮДИ В БАЛАХОНАХ В ТЕХТОНЕЛЯХ", "Мен&#255; окружают сумасшедшие!", "СИНГУЛЯРНОСТЬ НА СВОБОДЕ!!!" , "Оно в моей голове, оно в ваших головах тоже!", "Уберите, уберите его от мен&#255;!", "НАЧАЛЬНИК!!!!", "ЭТОТ ПИДОРАС ОБОСРАЛСЯ!!", "Они идут за мной!", "[pick("ЧЕРНЫЕ МЫШИ", "ЗЕЛЕНЫЕ ГЕНЕТИКИ", "ОХУЕВШИЕ КРАСНОЗАДЫЕ", "ЛЮДИ В БАЛАХОНАХ", "ЕБУЧИЕ АССИСТЕНТЫ", "БЛЯДСКИЕ КИБОРГИ", "КРИВОЖОПЫЕ МЕДИКИ", "СИНДИКАТОВЦЫ В КРАСНЫХ СКАФАНДРАХ")] [pick("ОХУЕЛИ", "УБИВАЮТ", "НАСИЛУЮТ", "РАЗМНОЖАЮТСЯ", "СОСУТ ХУИ")]!!!"))
				if(2)
