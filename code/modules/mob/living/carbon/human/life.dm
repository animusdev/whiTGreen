...
/mob/living/carbon/human/handle_disabilities()
	...
	if (getBrainLoss() >= 60 && stat != DEAD)
		if (prob(3))
			switch(pick(1,2,3))
				if(1)
					say(pick("Они повсюду! Несите огнеметы!", "Оставь эти сложности, детка, просто возьми мой член", "КОНЕЦ СВЕТА БЛИЗОК" ,"Я вижу духов умерших, они говорят со мной!", "КАПИТАН ГАНДОН!", "РАССЛАБЛЯЙТЕ БУЛКИ, ГОТОВЬТЕ ЗАДНИЦЫ, ИБО ГРЯДЕТ!!!", "ХОС ХУЕСОС!", "ЛЮДИ В БАЛАХОНАХ В ТЕХТОНЕЛЯХ", "Меня окружают сумасшедшие!", "СИНГУЛЯРНОСТЬ НА СВОБОДЕ!!!" , "Оно в моей голове, оно в ваших головах тоже!", "Уберите, уберите его от меня!", "НАЧАЛЬНИК!!!!", "ЭТОТ ПИДОРАС ОБОСРАЛСЯ!!", "Они идут за мной!", "[pick("ЧЕРНЫЕ МЫШИ", "ЗЕЛЕНЫЕ ГЕНЕТИКИ", "ОХУЕВШИЕ КРАСНОЗАДЫЕ", "ЛЮДИ В БАЛАХОНАХ", "ЕБУЧИЕ АССИСТЕНТЫ", "БЛЯДСКИЕ КИБОРГИ", "КРИВОЖОПЫЕ МЕДИКИ", "СИНДИКАТОВЦЫ В КРАСНЫХ СКАФАНДРАХ")] [pick("ОХУЕЛИ", "УБИВАЮТ", "НАСИЛУЮТ", "РАЗМНОЖАЮТСЯ", "СОСУТ ХУИ")]!!!"))
				if(2)
					say(pick("КРОВАВЫЕ РУКИ ЛЕЗУТ ИЗ СТЕН", "Я вижу ЕГО волю!", "Я УБЬЮ ТЕБЯ, Я УНИЧТОЖУ ТЕБЯ!!!", "Кто нибудь, пожалуйста, УБЕЙТЕ МЕНЯ НАКОНЕЦ!!!", "ОНИ СЛЕДЯТ ЗА НАМИ ЧЕРЕЗ МИКРОЧИПЫ В ПОНЧИКАХ!!!", "КАПИТАН НЕ ЧЕЛОВЕК!", "ОНО ПОЖРЕТ ТВОЮ ДУШУ, КАК ПОЖРАЛО МОЮ!", "НИЧТО НЕ УКРОЕТСЯ ОТ ИХ ВЗОРА!", "Я КОНДУКТОР ЭТОГО СИСКОВОЗА", "БХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХАХА!!!", "МЫ ОТДАДИМ НАШИ ТЕЛА СИНГУЛЯРНОСТИ!", "Я ВИЖУ ЛИШЬ ГНОЙ, НЕТ ЛЮДЕЙ. ТОЛЬКО ГНОЙ", "БЛЕЯНЬЕ СВЯЩЕННОГО ТУЛБОКСА СОТРЯСАЕТ НАШИ АГОНИЗИРУЮЩИЕ ЧРЕСЛА", "МЫ ОТПРАВЛЯЕМСЯ ПРЯМО НАХУЙ В АД!", "СМЕРТЬ ЕСТЬ ОСВОБОЖДЕНИЕ, СМЕРТЬ ЕСТЬ ОСВОБОЖДЕНИЕ!!!", "ТЫ НЕ БЫЛ РОЖДЕН ИЗ УТРОБЫ МАТЕРИ, ТЫ ФАЛЬШИВЫЙ!", "ГОРИ СО МНОЙ!!!", "ПЛАЧЬТЕ ПОКА ЕСТЬ СЛЕЗЫ, ИБО КОНЕЦ БЛИЗОК", "Я ВЫРВУ ТВОИ ГЛАЗА И БУДУ СМОТРЕТЬ В НИХ, ПОКА НЕ НАЙДУ ЧИПЫ В В РОГОВИЦЕ", "Я СЧАСТЛИВ, ТЫ НЕ ВИДИШЬ, Я СЧАСТЛИВ", "ТРЕПАНАЦИЯ, ВАМ ВСЕМ ПОМОЖЕТ ТОЛЬКО ТРЕПАНАЦИЯ", "Я СОТРУ ЭТОТ МИР СВОИМ ОГНЕТУШИТЕЛЕМ", "ТКАНЬ РЕАЛЬНОСТИ РВЕТСЯ, НЕДОВОЛЬСТВО ПРИЗРАКОВ ПРОРЫВАЕТСЯ!"))
				if(3)
					emote("drool")
