...
/mob/living/carbon/human/handle_disabilities()
   ...
   if (getBrainLoss() >= 60 && stat != DEAD)
      if (prob(3))
         switch(pick(1,2,3))
            if(1)
               say(pick("Îíè ÁîâÇþäó! ÍåÇèÄå îÊíåìåÄû!", "ÎÇÄàâü ýÄè ÇëîæíîÇÄè, äåÄêà, ÁðîÇÄî âîçüìè ìîé ÷ëåí", "ÊÎÍÅÖ ÇÂÅÄÀ ÁËÈÇÎÊ" ,"ß âèæó äóÊîâ óìåðÆèÊ, îíè Êîâîð&#255;Ä Çî ìíîé!", "ÊÀÁÈÄÀÍ ÊÀÍÄÎÍ!", "ÐÀÇÇËÀÁËßÉÄÅ ÁÓËÊÈ, ÊÎÄÎÂÜÄÅ ÇÀÄÍÈÖÛ, ÈÁÎ ÊÐßÄÅÄ!!!", "ÊÎÇ ÊÓÅÇÎÇ!", "ËÞÄÈ Â ÁÀËÀÊÎÍÀÊ Â ÄÅÊÄÎÍÅËßÊ", "Ìåí&#255; îêðóæàþÄ ÇóìàÇÆåäÆèå!", "ÇÈÍÊÓËßÐÍÎÇÄÜ ÍÀ ÇÂÎÁÎÄÅ!!!" , "Îíî â ìîåé Êîëîâå, îíî â âàÆèÊ ÊîëîâàÊ Äîæå!", "ÓáåðèÄå, óáåðèÄå åÊî îÄ ìåí&#255;!", "ÍÀ×ÀËÜÍÈÊ!!!!", "ÝÄÎÄ ÁÈÄÎÐÀÇ ÎÁÎÇÐÀËÇß!!", "Îíè èäóÄ çà ìíîé!", "[pick("×ÅÐÍÛÅ ÌÛÆÈ", "ÇÅËÅÍÛÅ ÊÅÍÅÄÈÊÈ", "ÎÊÓÅÂÆÈÅ ÊÐÀÇÍÎÇÀÄÛÅ", "ËÞÄÈ Â ÁÀËÀÊÎÍÀÊ", "ÅÁÓ×ÈÅ ÀÇÇÈÇÄÅÍÄÛ", "ÁËßÄÇÊÈÅ ÊÈÁÎÐÊÈ", "ÊÐÈÂÎÆÎÁÛÅ ÌÅÄÈÊÈ", "ÇÈÍÄÈÊÀÄÎÂÖÛ Â ÊÐÀÇÍÛÊ ÇÊÀÔÀÍÄÐÀÊ")] [pick("ÎÊÓÅËÈ", "ÓÁÈÂÀÞÄ", "ÍÀÇÈËÓÞÄ", "ÐÀÇÌÍÎÆÀÞÄÇß", "ÇÎÇÓÄ ÊÓÈ")]!!!"))
            if(2)
               say(pick("ÊÐÎÂÀÂÛÅ ÐÓÊÈ ËÅÇÓÄ ÈÇ ÇÄÅÍ", "ß âèæó ÅÊÎ âîëþ!", "ß ÓÁÜÞ ÄÅÁß, ß ÓÍÈ×ÄÎÆÓ ÄÅÁß!!!", "ÊÄî íèáóäü, ÁîæàëóéÇÄà, ÓÁÅÉÄÅ ÌÅÍß ÍÀÊÎÍÅÖ!!!", "ÎÍÈ ÇËÅÄßÄ ÇÀ ÍÀÌÈ ×ÅÐÅÇ ÌÈÊÐÎ×ÈÁÛ Â ÁÎÍ×ÈÊÀÊ!!!", "ÊÀÁÈÄÀÍ ÍÅ ×ÅËÎÂÅÊ!", "ÎÍÎ ÁÎÆÐÅÄ ÄÂÎÞ ÄÓÆÓ, ÊÀÊ ÁÎÆÐÀËÎ ÌÎÞ!", "ÍÈ×ÄÎ ÍÅ ÓÊÐÎÅÄÇß ÎÄ ÈÊ ÂÇÎÐÀ!", "ß ÊÎÍÄÓÊÄÎÐ ÝÄÎÊÎ ÇÈÇÊÎÂÎÇÀ", "ÁÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀÊÀ!!!", "ÌÛ ÎÄÄÀÄÈÌ ÍÀÆÈ ÄÅËÀ ÇÈÍÊÓËßÐÍÎÇÄÈ!", "ß ÂÈÆÓ ËÈÆÜ ÊÍÎÉ, ÍÅÄ ËÞÄÅÉ. ÄÎËÜÊÎ ÊÍÎÉ", "ÁËÅßÍÜÅ ÇÂßÙÅÍÍÎÊÎ ÄÓËÁÎÊÇÀ ÇÎÄÐßÇÀÅÄ ÍÀÆÈ ÀÊÎÍÈÇÈÐÓÞÙÈÅ ×ÐÅÇËÀ", "ÌÛ ÎÄÁÐÀÂËßÅÌÇß ÁÐßÌÎ ÍÀÊÓÉ Â ÀÄ!", "ÇÌÅÐÄÜ ÅÇÄÜ ÎÇÂÎÁÎÆÄÅÍÈÅ, ÇÌÅÐÄÜ ÅÇÄÜ ÎÇÂÎÁÎÆÄÅÍÈÅ!!!", "ÄÛ ÍÅ ÁÛË ÐÎÆÄÅÍ ÈÇ ÓÄÐÎÁÛ ÌÀÄÅÐÈ, ÄÛ ÔÀËÜÆÈÂÛÉ!", "ÊÎÐÈ ÇÎ ÌÍÎÉ!!!", "ÁËÀ×ÜÄÅ ÁÎÊÀ ÅÇÄÜ ÇËÅÇÛ, ÈÁÎ ÊÎÍÅÖ ÁËÈÇÎÊ", "ß ÂÛÐÂÓ ÄÂÎÈ ÊËÀÇÀ È ÁÓÄÓ ÇÌÎÄÐÅÄÜ Â ÍÈÊ, ÁÎÊÀ ÍÅ ÍÀÉÄÓ ×ÈÁÛ Â Â ÐÎÊÎÂÈÖÅ", "ß Ç×ÀÇÄËÈÂ, ÄÛ ÍÅ ÂÈÄÈÆÜ, ß Ç×ÀÇÄËÈÂ", "ÄÐÅÁÀÍÀÖÈß, ÂÀÌ ÂÇÅÌ ÁÎÌÎÆÅÄ ÄÎËÜÊÎ ÄÐÅÁÀÍÀÖÈß", "ß ÇÎÄÐÓ ÝÄÎÄ ÌÈÐ ÇÂÎÈÌ ÎÊÍÅÄÓÆÈÄÅËÅÌ", "ÄÊÀÍÜ ÐÅÀËÜÍÎÇÄÈ ÐÂÅÄÇß, ÍÅÄÎÂÎËÜÇÄÂÎ ÁÐÈÇÐÀÊÎÂ ÁÐÎÐÛÂÀÅÄÇß!"))
            if(3)
               emote("drool")
