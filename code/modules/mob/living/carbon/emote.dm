...
/mob/living/carbon/emote(var/act,var/m_type=1,var/message = null)
   ...
   switch(act)//Even carbon organisms want it alphabetically ordered..
      ...
      if ("blink")
         message = "<B>[src]</B> мор аеƒ."
         m_type = 1

      if ("blink_r")
         message = "<B>[src]</B> бы«ƒро мор аеƒ."
         m_type = 1
      ...
      if ("choke")
         if (!muzzled)
            ...
            message = "<B>[src]</B> издаЄƒ  ромкий ∆ум."
            m_type = 2
      ...
      if ("gasp")
         if (!muzzled)
            ...
            message = "<B>[src]</B> издаЄƒ ƒи ий ∆ум."
            m_type = 2
      ...
      if ("scream")
         if (!muzzled)
            ...
            message = "<B>[src]</B> издаЄƒ очень  ромкий ∆ум."
            m_type = 2

      if ("shake")
         message = "<B>[src]</B> качаеƒ  оловой."
         m_type = 1
      ...
      if ("sneeze")
         if (!muzzled)
            ...
            message = "<B>[src]</B> издаЄƒ «ƒранный звук."
            m_type = 2
