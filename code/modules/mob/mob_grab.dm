...
/obj/item/weapon/grab/proc/s_click(obj/screen/S)
	...
	if(state < GRAB_AGGRESSIVE)
		if(!allow_upgrade)
			return
		assailant.visible_message("<span class='warning'>[assailant] grabs [affecting] agressively!</span>")
		...
		if(state < GRAB_NECK)
			...
			assailant.visible_message("<span class='warning'>[assailant] has reinforced \his grip on [affecting]!</span>")
			state = GRAB_NECK
