...
/proc/electrocute_mob(mob/living/carbon/M as mob, var/power_source, var/obj/source, var/siemens_coeff = 1.0)
	...
	var/drained_hp = M.electrocute_act(shock_damage, source, siemens_coeff,PN) //zzzzzzap!
...
/area/proc/get_apc()
	if(!apc||apc.loc.loc!=src)
		//apc.area=null #May call the runtime errors somewhere, like "null.area"
		apc=null
	return apc
