...
/datum/round_event/anomaly/anomaly_bluespace/announce()
   priority_announce("«аре и«ƒрировано возникновение не«ƒабильной «убЅро«ƒран«ƒвенной аномалии. Ѕриблизиƒельное ме«ƒона ождение: [impact_area.name].", "Anomaly Alert")
   ...
   if(newAnomaly.loc)//If it hasn't been neutralized, it's time to warp half the station away jeez
      ...
      if(T)
         ...
         if(chosen)
            ...
            priority_announce("«афик«ирована значиƒельна&#255; ƒран«локаци&#255; маƒерии.", "Anomaly Alert")
