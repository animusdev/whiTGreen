...
/datum/round_event/shuttle_loan
   ...
   var/thanks_msg = "¬ каче«ƒве бла одарно«ƒи мы оƒЅравл&#255;ем вам немно о доЅолниƒельны  очков «набжени&#255;."
   var/dispatched = 0
   announceWhen   = 1
...
/datum/round_event/shuttle_loan/announce()
   ...
   switch(dispatch_type)
      if(HIJACK_SYNDIE)
         priority_announce("«индикаƒов«ка&#255;  руЅЅа за ваƒа Ѕыƒаеƒ«&#255; Ѕроникнуƒь на ва∆у «ƒанцию. ќƒЅравьƒе за ними ∆аƒƒл и избавьƒе на« оƒ эƒой  оловной боли.","Centcom Counter Intelligence")
      if(RUSKY_PARTY)
         priority_announce(" учка разъ&#255;ренны  ру««ки  очень  очеƒ Ѕобываƒь на вечеринке. ќƒЅравьƒе за ними ∆аƒƒл и у«ƒройƒе им ƒЄЅлый ЅриЄм.","Centcom Russian Outreach Program")
      if(SPIDER_GIFT)
         priority_announce(" лан Ѕаука оƒЅравил нам за адочный Ѕодарок. ќƒЅравьƒе за ним ∆аƒƒл и узнайƒе, чƒо внуƒри.","Centcom Diplomatic Corps")
      if(DEPARTMENT_RESUPPLY)
         priority_announce("Ќа ÷  заказали вдвое боль∆е ЅриЅа«ов, чем нужно. ќƒЅравьƒе ∆аƒƒл и забериƒе изли∆ек.","Centcom Supply Department")
         thanks_msg = "∆аƒƒл Ѕрилеƒиƒ через 5 минуƒ."
         bonus_points = 0

/datum/round_event/shuttle_loan/proc/loan_shuttle()
   priority_announce(thanks_msg, " рузовой ∆аƒƒл Ѕри∆варƒовал«&#255; к ÷ .")
   ...
   switch(dispatch_type)
      if(HIJACK_SYNDIE)
         SSshuttle.centcom_message += "<font color=blue>Ѕрибываеƒ «индикаƒов«ка&#255;  руЅЅа за ваƒа.</font>"
      if(RUSKY_PARTY)
         SSshuttle.centcom_message += "<font color=blue>Ѕрибываеƒ  руЅЅа ру««ки  ƒу«овщиков.</font>"
      if(SPIDER_GIFT)
         SSshuttle.centcom_message += "<font color=blue>Ѕрибываеƒ Ѕодарок  лана Ѕаука.</font>"
      if(DEPARTMENT_RESUPPLY)
         SSshuttle.centcom_message += "<font color=blue>Ѕрибываеƒ изли∆ек ЅриЅа«ов.</font>"
