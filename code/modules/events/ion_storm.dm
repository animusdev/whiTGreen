...
/datum/round_event/ion_storm/announce()
   if(announceEvent == ION_ANNOUNCE || (announceEvent == ION_RANDOM && prob(ionAnnounceChance)))
      priority_announce("¬ районе «ƒанции зафик«ирован ионный ∆ƒорм. Ѕожалуй«ƒа, Ѕроверьƒе в«е авƒономные инƒеллекƒуальные «и«ƒемы на Ѕредмеƒ возможны  о∆ибок.", "Anomaly Alert", 'sound/AI/ionstorm.ogg')
