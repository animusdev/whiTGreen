...
/datum/round_event/vent_clog/announce()
   priority_announce("¬ «и«ƒеме венƒил&#255;ции Ѕроизо∆ло Ѕовы∆ение аэродинамиче«ко о давлени&#255;. ¬озможен выбро« «одержимо о фильƒров в аƒмо«феру «ƒанции.", "Atmospherics alert")
