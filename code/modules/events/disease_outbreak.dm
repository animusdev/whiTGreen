...
/datum/round_event/disease_outbreak/announce()
	priority_announce("Зафиксирована вспышка вирусной инфекции 7 уровня биологической угрозы, персоналу необходимо остановить её распространение.", "Biohazard Alert", 'sound/AI/outbreak7.ogg')
