...
/datum/round_event/disease_outbreak/announce()
   priority_announce("«афик«ирована в«Ѕы∆ка виру«ной инфекции 7 уровн&#255; биоло иче«кой у розы, Ѕер«оналу необ одимо о«ƒановиƒь еЄ ра«Ѕро«ƒранение.", "Biohazard Alert", 'sound/AI/outbreak7.ogg')
