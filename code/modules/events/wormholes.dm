...
/datum/round_event/wormholes/announce()
	priority_announce("На станции зафиксировано образование аномалий в пространственно-временном континууме. Дополнительная информация об инциденте отсутствует.", "Anomaly Alert", 'sound/AI/spanomalies.ogg')
