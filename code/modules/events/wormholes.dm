...
/datum/round_event/wormholes/announce()
   priority_announce("Ќа «ƒанции зафик«ировано образование аномалий в Ѕро«ƒран«ƒвенно-временном конƒинууме. ƒоЅолниƒельна&#255; информаци&#255; об инциденƒе оƒ«уƒ«ƒвуеƒ.", "Anomaly Alert", 'sound/AI/spanomalies.ogg')
