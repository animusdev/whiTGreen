...
/datum/round_event/blob/announce()
   priority_announce("«афик«ирована в«Ѕы∆ка виру«ной инфекции 5 уровн&#255; биоло иче«кой у розы, Ѕер«оналу необ одимо о«ƒановиƒь еЄ ра«Ѕро«ƒранение.", "Biohazard Alert", 'sound/AI/outbreak5.ogg')
