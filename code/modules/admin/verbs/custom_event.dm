...
/client/proc/cmd_admin_change_custom_event()
   ...
   world << "<h1 class='alert'>ÈÂÎÍÄ, ÁÎÇÎÍÛ!</h1>"
   world << "<h2 class='alert'>ÇóÄü Äîêîâà:</h2>"
...
mob/verb/cmd_view_custom_event()
   ...
   if(!custom_event_msg || custom_event_msg == "")
      src << "ÇåÊîäí&#255; èâîíÄà íåÄ."
      return

   src << "<h1 class='alert'>ÈâîíÄ!</h1>"
   src << "<h2 class='alert'>ÇóÄü Äîêîâà:</h2>"
