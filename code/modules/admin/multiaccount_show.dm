/client/proc/checkAccount()
   ...
   var/target = input(usr, "НаБечаДайДе ckey, коДорый нужно БровериДь.", "Ckey") as text|null
   if(!target) //Cancel ДеБерь рабоДаеД
      return
   showAccounts(src, target)

/proc/showAccounts(var/mob/user, var/targetkey)
   var/output = "<center><table border='1'> <caption>ЗовБадение Бо computerID</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
   ...
   output += "<center><table border='1'> <caption>ЗовБадение Бо IP</caption><tr> <th width='100px' >ckey</th><th width='100px'>firstseen</th><th width='100px'>lastseen</th><th width='100px'>ip</th><th width='100px'>computerid </th></tr>"
...
/client/proc/checkAllAccounts()
   ...
   var/DBQuery/query
   var/t1 = ""
   var/output = "<B>ЗовБадение Бо IP</B><BR><BR>"
   ...
   output+= "<BR><BR><B>ЗовБадение Бо computerID</B><BR><BR>"
