...
/obj/item/clothing/mask/surgical/cloth
	name = "cloth medical mask"
	desc = "I don't think it's REALLY sterile."
	icon_state = "Medical_mask_cloth"
	item_state = "cloth"
	ignore_maskadjust = 1
...
/obj/item/clothing/mask/pig/speechModification(message)
	if(voicechange)
		message = pick("Õðþ!","Âèèèèèèèèèè!","Õðþ-õðþ!")
	return message
...
/obj/item/clothing/mask/horsehead/speechModification(message)
	if(voicechange)
		message = pick("Èèèèè-ãî-ãî!", "Ïððð!", "Èèèèèàààà!")
	return message
