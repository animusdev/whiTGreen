...
/obj/item/clothing/under/rank/research_director
	...
	r_name = "костюм исследовательского директора"
	icon_state = "director"
	item_state = "lb_suit"
	item_color = "director"
