...
/obj/item/clothing/tie/black
	name = "black tie"
	r_name = "чЄрный галстук"
	ablative_case = "чЄрным галстуком"
	icon_state = "blacktie"
	item_color = "blacktie"
...
/obj/item/clothing/tie/stethoscope
	name = "stethoscope"
	r_name = "стетоскоп"
	ablative_case = "прикреплЄнным стетоскопом"
...
/obj/item/clothing/tie/medal/attack(mob/living/carbon/human/M, mob/living/user)
	if(ishuman(M) && (user.a_intent == "help"))
		...
		else user << "<span class='warning'>ћедаль можно прикрепить только к костюму!</span>"
	else ..()
...
/obj/item/clothing/tie/armband/science
	...
	r_name = "пов&#255;зка с эмблемой –нƒ"
	accusative_case = "пов&#255;зку с эмблемой –нƒ"
...
/obj/item/clothing/tie/scarf/green
	name = "green scarf"
	r_name = "зелЄный шарф"
	ablative_case = "зелЄным шарфом"
	icon_state = "greenscarf"
	item_color = "greenscarf"

/obj/item/clothing/tie/scarf/darkblue
	name = "dark blue scarf"
	r_name = "тЄмно-синий шарф"
	ablative_case = "тЄмно-синим шарфом"
	icon_state = "darkbluescarf"
	item_color = "darkbluescarf"

/obj/item/clothing/tie/scarf/purple
	name = "purple scarf"
	r_name = "фиолетовый шарф"
	ablative_case = "фиолетовым шарфом"
...
/obj/item/clothing/tie/scarf/yellow
	name = "yellow scarf"
	r_name = "жЄлтый шарф"
	ablative_case = "жЄлтым шарфом"
	icon_state = "yellowscarf"
	item_color = "yellowscarf"

/obj/item/clothing/tie/scarf/orange
	name = "orange scarf"
	r_name = "оранжевый шарф"
	ablative_case = "оранжевым шарфом"
...
/obj/item/clothing/tie/scarf/black
	name = "black scarf"
	r_name = "чЄрный шарф"
	ablative_case = "чЄрным шарфом"
	icon_state = "blackscarf"
	item_color = "blackscarf"

/obj/item/clothing/tie/scarf/zebra
	name = "zebra scarf"
	r_name = "полосатый шарф"
	ablative_case = "полосатым шарфом"
	icon_state = "zebrascarf"
	item_color = "zebrascarf"

/obj/item/clothing/tie/scarf/christmas
	name = "christmas scarf"
	r_name = "рождественский шарф"
	ablative_case = "рождественским шарфом"
